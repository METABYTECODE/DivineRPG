...
public enum BulletType {
    ...
    MAELSTROM_SHOT(12, ProjectileLoc("maelstrom"), ParticleRegistry.APALACHIA_PORTAL, BulletDamageType.MAGIC),
    ...
    GENERALS_STAFF_SPRAY(13, ProjectileLoc("generals_staff"), ParticleRegistry.WILDWOOD_PORTAL, BulletSpecial.NONE),
    GENERALS_STAFF_SHOT(13, ProjectileLoc("generals_staff"), ParticleRegistry.WILDWOOD_PORTAL, BulletType.GENERALS_STAFF_SPRAY, 4),
    STAR(13, ProjectileLoc("starlight"), ParticleRegistry.EDEN_PORTAL, BulletSpecial.SKY),
    METEOR(15, ProjectileLoc("meteor"), ParticleRegistry.MORTUM_PORTAL, BulletSpecial.SKY),
    ...
    //Blitz
    EDEN_BLITZ_SHOT(10, ProjectileLoc("eden_blitz"), ParticleRegistry.EDEN_PORTAL, BulletDamageType.PHYSIC),
    WILDWOOD_BLITZ_SHOT(12, ProjectileLoc("wildwood_blitz"), ParticleRegistry.WILDWOOD_PORTAL, BulletDamageType.PHYSIC),
    APALACHIA_BLITZ_SHOT(14, ProjectileLoc("apalachia_blitz"), ParticleRegistry.APALACHIA_PORTAL, BulletDamageType.PHYSIC),
    SKYTHERN_BLITZ_SHOT(16, ProjectileLoc("skythern_blitz"), ParticleRegistry.SKYTHERN_PORTAL, BulletDamageType.PHYSIC),
    MORTUM_BLITZ_SHOT(18, ProjectileLoc("mortum_blitz"), ParticleRegistry.MORTUM_PORTAL, BulletDamageType.PHYSIC),
    HALITE_BLITZ_SHOT(20, ProjectileLoc("halite_blitz"), ParticleRegistry.HALITE_PORTAL, BulletDamageType.PHYSIC),

    //Phasers
    EDEN_PHASER_SHOT(8, ProjectileLoc("eden_phaser"), ParticleRegistry.EDEN_PORTAL, BulletDamageType.MAGIC),
    WILDWOOD_PHASER_SHOT(10, ProjectileLoc("wildwood_phaser"), ParticleRegistry.WILDWOOD_PORTAL, BulletDamageType.MAGIC),
    APALACHIA_PHASER_SHOT(12, ProjectileLoc("apalachia_phaser"), ParticleRegistry.APALACHIA_PORTAL, BulletDamageType.MAGIC),
    SKYTHERN_PHASER_SHOT(14, ProjectileLoc("skythern_phaser"), ParticleRegistry.SKYTHERN_PORTAL, BulletDamageType.MAGIC),
    MORTUM_PHASER_SHOT(16, ProjectileLoc("mortum_phaser"), ParticleRegistry.MORTUM_PORTAL, BulletDamageType.MAGIC),
    HALITE_PHASER_SHOT(18, ProjectileLoc("halite_phaser"), ParticleRegistry.HALITE_PORTAL, BulletDamageType.MAGIC),
    ...
    MAGE_SHOT(10, blank(), ParticleRegistry.WILDWOOD_PORTAL, BulletDamageType.PHYSIC),
    SPELLBINDER_SHOT(12, blank(), ParticleRegistry.APALACHIA_PORTAL, BulletDamageType.PHYSIC),
    ADVANCED_CORI_SHOT(30, ProjectileLoc("cori_shot"), BulletDamageType.PHYSIC),
    MYSTIC_SHOT(13, blank(), ParticleRegistry.SKYTHERN_PORTAL, BulletDamageType.PHYSIC),
    SORCERER_SHOT(14, blank(), ParticleRegistry.MORTUM_PORTAL, BulletDamageType.PHYSIC),
    ...
    SUNSTORM(12, blank(), ParticleRegistry.EDEN_PORTAL, BulletDamageType.PHYSIC),
    EXPERIENCED_CORI_SHOT(80, ProjectileLoc("cori_shot"), BulletDamageType.PHYSIC),
    TWILIGHT_DEMON_BLACK_SHOT(16, ProjectileLoc("twilight_demon_shot"), ParticleRegistry.MORTUM_PORTAL, BulletDamageType.PHYSIC),
    TWILIGHT_DEMON_RED_SHOT(16, ProjectileLoc("twilight_demon_shot"), ParticleRegistry.TWILIGHT_PORTAL, BulletDamageType.PHYSIC),
    ...
    LUNA_SPARKLER(12, blank(), ParticleRegistry.APALACHIA_PORTAL, BulletDamageType.PHYSIC),

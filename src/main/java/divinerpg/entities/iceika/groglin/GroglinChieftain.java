...
public class GroglinChieftain extends Groglin {
	...
	@Override protected void updateTrades() {
		...
		DivineTrades[] tradetrades = new DivineTrades[]{
                ...
                new EntityDivineMerchant.DivineMapTrades(new ItemStack(ItemRegistry.olivine.get(), 20), new ItemStack(ItemRegistry.raw_wolpertinger_meat.get(), 5), "filled_map.groglin_raid_target", RAID_TARGETS, MapDecorationTypes.TARGET_X, 15),

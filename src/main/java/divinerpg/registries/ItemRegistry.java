...
public class ItemRegistry {
    ...
    //Tools, Weapons & Armor
            ...
            icicle_bane = registerItem("icicle_bane", () -> new ItemModSword(ToolStats.ICICLE_BANE, RarityList.ICICLE)),
            glacial_blade = registerItem("glacial_blade", () -> new ItemModSword(ToolStats.GLACIAL_BLADE, RarityList.ICICLE)),
            ...
            divine_sword = registerItem("divine_sword", () -> new ItemModSword(ToolStats.DIVINE_SWORD, RarityList.DIVINE)),
            red_divine_sword = registerItem("red_divine_sword", () -> new ItemModSword(ToolStats.DIVINE_SWORD, RarityList.RED)),
            yellow_divine_sword = registerItem("yellow_divine_sword", () -> new ItemModSword(ToolStats.DIVINE_SWORD, RarityList.UNCOMMON)),
            green_divine_sword = registerItem("green_divine_sword", () -> new ItemModSword(ToolStats.DIVINE_SWORD, RarityList.GREEN)),
            blue_divine_sword = registerItem("blue_divine_sword", () -> new ItemModSword(ToolStats.DIVINE_SWORD, RarityList.BLUE)),
            gray_divine_sword = registerItem("gray_divine_sword", () -> new ItemModSword(ToolStats.DIVINE_SWORD, RarityList.GRAY)),
            ...
            eden_blade = registerItem("eden_blade", () -> new ItemModSword(ToolStats.EDEN_BLADE, RarityList.EDEN)),
            wildwood_blade = registerItem("wildwood_blade", () -> new ItemModSword(ToolStats.WILDWOOD_BLADE, RarityList.WILDWOOD)),
            apalachia_blade = registerItem("apalachia_blade", () -> new ItemModSword(ToolStats.APALACHIA_BLADE, RarityList.APALACHIA)),
            skythern_blade = registerItem("skythern_blade", () -> new ItemModSword(ToolStats.SKYTHERN_BLADE, RarityList.SKYTHERN)),
            mortum_blade = registerItem("mortum_blade", () -> new ItemModSword(ToolStats.MORTUM_BLADE, RarityList.MORTUM)),
            halite_blade = registerItem("halite_blade", () -> new ItemModSword(ToolStats.HALITE_BLADE, RarityList.HALITE)),
            ...
            soulfire_bow = registerItem("soulfire_bow", () -> new ItemBow(new Properties(), 0, 72000, 1.5F, soulfire_arrow, RarityList.BLUE)),
            ...
            eden_bow = registerItem("eden_bow", () -> new ItemBow(new Properties(), 1517, 72000, 1.3F, null, RarityList.EDEN)),
            wildwood_bow = registerItem("wildwood_bow", () -> new ItemBow(new Properties(), 1624, 36000, 1.4F, null, RarityList.WILDWOOD)),
            apalachia_bow = registerItem("apalachia_bow", () -> new ItemBow(new Properties(), 1778, 72000, 1.5F, null, RarityList.APALACHIA)),
            skythern_bow = registerItem("skythern_bow", () -> new ItemBow(new Properties(), 1879, 36000, 1.6F, null, RarityList.SKYTHERN)),
            mortum_bow = registerItem("mortum_bow", () -> new ItemBow(new Properties(), 1990, 72000, 1.7F, null, RarityList.MORTUM)),
            halite_bow = registerItem("halite_bow", () -> new ItemBow(new Properties(), 2114, 36000, 1.8F, null, RarityList.HALITE)),
    ...
    bedrock_shovel = registerItem("bedrock_shovel", () -> new ItemModShovel(ToolStats.BEDROCK_SHOVEL, new Properties().fireResistant())),
            ...
            bedrock_hoe = registerItem("bedrock_hoe", () -> new ItemModHoe(ToolStats.BEDROCK_HOE, 0, new Properties().fireResistant())),
    ...
    divine_shovel = registerItem("divine_shovel", () -> new ItemModShovel(ToolStats.DIVINE_SHOVEL, RarityList.DIVINE)),
            ...
            divine_hoe = registerItem("divine_hoe", () -> new ItemModHoe(ToolStats.DIVINE_HOE, 0, RarityList.DIVINE)),
            divine_shickaxe = registerItem("divine_shickaxe", () -> new ItemShickaxe(ToolStats.DIVINE_SHICKAXE, RarityList.DIVINE)),
    ...
    eden_shovel = registerItem("eden_shovel", () -> new ItemModShovel(ToolStats.EDEN_SHOVEL, RarityList.EDEN)),
            ...
            eden_hoe = registerItem("eden_hoe", () -> new ItemModHoe(ToolStats.EDEN_HOE, 0, RarityList.EDEN)),
            eden_shickaxe = registerItem("eden_shickaxe", () -> new ItemShickaxe(ToolStats.EDEN_SHICKAXE, RarityList.EDEN)),
    ...
    wildwood_shovel = registerItem("wildwood_shovel", () -> new ItemModShovel(ToolStats.WILDWOOD_SHOVEL, RarityList.WILDWOOD)),
            ...
            wildwood_hoe = registerItem("wildwood_hoe", () -> new ItemModHoe(ToolStats.WILDWOOD_HOE, 0, RarityList.WILDWOOD)),
            wildwood_shickaxe = registerItem("wildwood_shickaxe", () -> new ItemShickaxe(ToolStats.WILDWOOD_SHICKAXE, RarityList.WILDWOOD)),
    ...
    apalachia_shovel = registerItem("apalachia_shovel", () -> new ItemModShovel(ToolStats.APALACHIA_SHOVEL, RarityList.APALACHIA)),
            ...
            apalachia_hoe = registerItem("apalachia_hoe", () -> new ItemModHoe(ToolStats.APALACHIA_HOE, 0, RarityList.APALACHIA)),
            apalachia_shickaxe = registerItem("apalachia_shickaxe", () -> new ItemShickaxe(ToolStats.APALACHIA_SHICKAXE, RarityList.APALACHIA)),
    ...
    skythern_shovel = registerItem("skythern_shovel", () -> new ItemModShovel(ToolStats.SKYTHERN_SHOVEL, RarityList.SKYTHERN)),
            ...
            skythern_hoe = registerItem("skythern_hoe", () -> new ItemModHoe(ToolStats.SKYTHERN_HOE, 0, RarityList.SKYTHERN)),
            skythern_shickaxe = registerItem("skythern_shickaxe", () -> new ItemShickaxe(ToolStats.SKYTHERN_SHICKAXE, RarityList.SKYTHERN)),
    ...
    mortum_shovel = registerItem("mortum_shovel", () -> new ItemModShovel(ToolStats.MORTUM_SHOVEL, RarityList.MORTUM)),
            ...
            mortum_hoe = registerItem("mortum_hoe", () -> new ItemModHoe(ToolStats.MORTUM_HOE, 0, RarityList.MORTUM)),
            mortum_shickaxe = registerItem("mortum_shickaxe", () -> new ItemShickaxe(ToolStats.MORTUM_SHICKAXE, RarityList.MORTUM)),

    halite_shickaxe = registerItem("halite_shickaxe", () -> new ItemShickaxe(ToolStats.HALITE_SHICKAXE, RarityList.HALITE)),
    ...
    //Vethean Swords
            ...
            //Vethean Bows
            teaker_bow = registerItemVethean("teaker_bow", () -> new VetheanBow(new Properties(), 0, 72000, .9F, null, RarityList.TEAKER)),
            amthirmis_bow = registerItemVethean("amthirmis_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1, null, RarityList.AMTHIRMIS)),
            darven_bow = registerItemVethean("darven_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1.1F, null, RarityList.DARVEN)),
            cermile_bow = registerItemVethean("cermile_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1.2F, null, RarityList.CERMILE)),
            pardimal_bow = registerItemVethean("pardimal_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1.3F, null, RarityList.PARDIMAL)),
            quadrotic_bow = registerItemVethean("quadrotic_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1.4F, null, RarityList.QUADROTIC)),
            karos_bow = registerItemVethean("karos_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1.5F, null, RarityList.KAROS)),
            heliosis_bow = registerItemVethean("heliosis_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1.6F, null, RarityList.HELIOSIS)),
            arksiane_bow = registerItemVethean("arksiane_bow", () -> new VetheanBow(new Properties(), 0, 72000, 1.7F, null, RarityList.ARKSIANE)),
